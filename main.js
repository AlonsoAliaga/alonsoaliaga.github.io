...
`)
  ...
  function loadChecking() {
   ...
   let link = atob("aHR0cHM6Ly9hbG9uc29hcGkuZGlzY2xvdWQuYXBwL2NoZWNraW5nP3NpdGU9PHNpdGU+JmtleT08a2V5Pg==")
    .replace(/<site>/g,"alonsoaliaga").replace(/<key>/g,"KEY-A");
     ...
     $.ajax({
       ...
       success: function (result) {
          ...
          if(isNaN(result)) {
           ...
           counter.textContent = `🟢 ${result} online viewing our information!`;
  ...
  function loadCounter() {
   let link = atob("aHR0cHM6Ly9hbG9uc29hcGkuZGlzY2xvdWQuYXBwL2NvdW50ZXI/c2l0ZT08c2l0ZT4ma2V5PTxrZXk+").replace(/<site>/g,"alonsoaliaga").replace(/<key>/g,"KEY-A");
